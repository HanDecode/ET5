...
########## kmh
from seq2seq_data_processor import YNAT_Processor
...
def main():
    ...
    compute_metrics_fn = (build_compute_metrics_fn_et5(tokenizer) if training_args.predict_with_generate else None)
    ##########
